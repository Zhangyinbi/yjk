 ...
 */
public class TraditionListView extends ListView implements OnScrollListener {
    ...
    public TraditionListView(Context pContext, AttributeSet pAttrs) {
        super(pContext, pAttrs);
        init(pContext);
    }

    public TraditionListView(Context pContext) {
        super(pContext);
        init(pContext);
    }

    public TraditionListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
    ...
    private void addHeadView() {
        ...
        mArrowImageView.setColorFilter(getResources().getColor(R.color.gray));
