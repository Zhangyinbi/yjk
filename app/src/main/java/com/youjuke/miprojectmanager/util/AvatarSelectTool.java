...
import com.hbw.library.utils.SDCardHelper;
...
//		showSelectDialog();
    ...
    public void getPhotoAlbum() {
        ...
        if (SDCardHelper.getInstance().sdCardMounted()) {
            ...
            activity.startActivityForResult(intent, AVTATR_ALBUM_CROP_CODE);
        } else {
            Toast.makeText(activity, "没有检测到SdCard卡", Toast.LENGTH_LONG).show();
        }
    }
