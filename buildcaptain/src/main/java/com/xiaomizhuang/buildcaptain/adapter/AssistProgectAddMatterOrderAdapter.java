...
import com.xiaomizhuang.buildcaptain.view.PopProgectAddMatterOrderOrder;
...
//                            ",position = " + position);
                    ...
                    orderlists.get(position).setTotalprice(Integer.parseInt(text.toString()) * Float.parseFloat(dataList.get(position).getPrice()) + "");
                    orderlists.get(position).setShl_count((Integer.parseInt(text.toString()) *  Float.parseFloat(orderlists.get(position).getShl()) + Integer.parseInt(text.toString()) + ""));
                } else {
