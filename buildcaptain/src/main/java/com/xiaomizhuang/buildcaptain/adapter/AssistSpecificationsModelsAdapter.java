...
import com.xiaomizhuang.buildcaptain.activity.AssistSpecificationsModelsActivity;
 ...
 */
public class AssistSpecificationsModelsAdapter extends AbsBaseAdapter<AssistSpecificationsModels>{
    private Context context = null;

    public AssistSpecificationsModelsAdapter(Context context,List<AssistSpecificationsModels> dataList) {
        super(dataList);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        holder.textView.setText(getDataList().get(position).getNorms());
        return v;
    }
