...
import com.youjuke.miprojectmanager.entity.PayRecord;
import com.youjuke.miprojectmanager.util.HttpConstant;

/**
 * 付款记录Activity
 *
 * @FileName: com.youjuke.miprojectmanager.activity.PayRecordActivity.java
 * @author: Yangbang
...
public class PayRecordActivity extends MiBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        intent.putExtra("baoming_id", bm_id);
        ...
        switch (msg.what) {
            case REQUEST_SUCCESS:
                ...
                if (payRecord.getTotal_refund_amount() == 0) {
                    ...
                    tv_refund_money.setTextColor(getResources().getColor(R.color.text_d2d2d2));
