...
public class PopwChange extends PopupWindow {
	private View view;
	private TextView textView_pop_chang_camera, textView_pop_chang_photo,
			textView_pop_window_cancel;
	...
	public PopwChange(Activity context, OnClickListener clickListener) {
		...
		textView_pop_chang_camera = (TextView) view
				.findViewById(R.id.textView_pop_chang_camera);
		textView_pop_chang_photo = (TextView) view
				.findViewById(R.id.textView_pop_chang_photo);
		textView_pop_window_cancel = (TextView) view
				.findViewById(R.id.textView_pop_window_cancel);
