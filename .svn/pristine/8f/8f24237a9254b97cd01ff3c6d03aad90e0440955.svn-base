...
//    private int mHeaderForeColor = 0xffffffff;
    private int mHeaderForeColor = 0xffeeeeee;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setAttrs(attrs);
        mPullHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 95, context.getResources().getDisplayMetrics());
        mHeaderHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 60, context.getResources().getDisplayMetrics());
